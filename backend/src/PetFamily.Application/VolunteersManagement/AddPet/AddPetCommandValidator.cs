...
namespace PetFamily.Application.VolunteersManagement.AddPet
{
    public class AddPetCommandValidator : AbstractValidator<AddPetCommand>
    {
        public AddPetCommandValidator()
        {
            ...
            RuleFor(c => c.Color).MustBeValueObject(PetColor.Create);

            RuleFor(c => c.HealthInfo).MustBeValueObject(PetHealthInfo.Create);

            RuleFor(c => c.Address).MustBeValueObject(a => Address.Create(
            ...
            RuleFor(c => c.BirthDate).MustBeDate(DateTime.Parse);
