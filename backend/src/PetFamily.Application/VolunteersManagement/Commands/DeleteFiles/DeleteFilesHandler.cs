...
public class DeleteFilesHandler : ICommandHandler<string, DeleteFilesCommand>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var filesToDelete = command.ObjectNames.Select(o => new FileInfo(
            o.ToLower(),
            command.BucketName.ToLower()));
